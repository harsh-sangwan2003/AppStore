<%@ Page Language="C#" AutoEventWireup="true" Theme="Downloads" CodeBehind="Admin.aspx.cs" Inherits="AppStore.Admin" %>
...
<body>
    ...
    <aside class="sidebar">
      ...
      <nav class="nav">
        <ul>
          ...
          <li><a href="Profile.aspx" id="profile">Profile</a></li>
    ...
    <section class="twitter">
      <div class="container">
        ...
        <div class="box">
            <a target="_blank" href="https://www.hike.com/">
                <img src="images/hike.png" alt="hike">
            </a>
            <button type="submit" class="btn" onclick="mouseClick()">Download</button>
        </div>
